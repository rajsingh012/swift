...
import { Accordion, Button, Card, Text } from '@swift/components'
import {
  Add,
  ArrowRight,
  Check,
  ...
  return (
    <div className="grid gap-10">
      ...
      <section>
        ...
        <Accordion type="single" collapsible defaultValue="overview" className="max-w-2xl">
