...
/**
 * Two-column grid: [box] [text]. `align-top` keeps the box pinned to the
 * first line of text when label + description wrap onto multiple rows.
 */
export const rootClasses =
  'inline-grid grid-cols-[auto_1fr] gap-x-2 align-top text-content-strong ' +
